import os
from ctypes import cdll, c_long, c_uint32, c_uint16, c_uint8, byref, create_string_buffer, c_bool, c_char, c_char_p, \
    c_int, c_int16, c_int8, c_double, c_float, sizeof, c_voidp, Structure
...
class TLPM:
    ...
    def __init__(self):
        if sizeof(c_voidp) == 4:
            self.dll = cdll.LoadLibrary("G:\\My Drive\\Ba Tagging\\code\\microscope_control\\TLPM_32.dll")
        else:
            self.dll = cdll.LoadLibrary("G:\\My Drive\\Ba Tagging\\code\\microscope_control\\TLPM_64.dll")
    ...
    def setPowerCalibrationPoints(self, index, pointCounts, wavelengths, powerCorrectionFactors, author,
                                  sensorPosition):
        """
        ...
        pInvokeResult = self.dll.TLPM_setPowerCalibrationPoints(self.devSession, index, pointCounts, wavelengths,
                                                                powerCorrectionFactors, author, sensorPosition)
        self.__testForError(pInvokeResult)
        return pInvokeResult
